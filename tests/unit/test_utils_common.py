...
def test_query_from_duckdb_replace():
    # query_using_duckdb(
    #     db_path='database/web-scraping.db',
    #     query=f"""
    #         CREATE TABLE klhk_air_quality_2023_10_22 AS FROM read_parquet (
    #             's3://web-scraping/air_quality/20231012_*.parquet'
    #         );
    #         DROP TABLE klhk_air_quality;
    #         ALTER TABLE klhk_air_quality_2023_10_22 RENAME TO klhk_air_quality;
    #     """
    # )
    query_using_duckdb(
            db_path='database/web-scraping.db',
